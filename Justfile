...
macos:
    ...
    cmake --install build/macos  --prefix build/install/macos --config Release
...
ios:
    ...
    cmake --install build/ios  --prefix build/install/ios --config Release
...
ios-sim:
    ...
    cmake --install build/ios-sim --prefix build/install/ios-sim --config Release
